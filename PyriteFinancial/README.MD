...
| IconActivity            | BlackBerry Spark SDK secure shared preference storage.<br />Enabling of threat data collection.<br />Enabling of biometric authentication. |
